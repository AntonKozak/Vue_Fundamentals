                    ...
                    <div class="card-body p-4">
                        ...
                        <form @submit.prevent="onSignUpSubmit">
                            <div class="mb-3">
                                ...
                                <input v-model="formObject.name" type="text" class="form-control" id="name" />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="role" v-model="formObject.role">
                            ...
                            <div class="mb-3">
                                ...
                                <input v-model="formObject.confirmPassword" type="password" class="form-control" id="confirmPassword" />
                            </div>
                            ...
                            <button :disabled="isLoading" type="submit" class="btn btn-secondary w-100">
                                <span v-if="isLoading" class="spinner-border spinner-border-sm me-2"> </span> Sign Up</button>
                        </form>

                        <div class="text-center mt-3">
                            <router-link :to="APP_ROUTES_NAMES.SIGN_IN">Already have an account? Login</router-link>
                        </div>
                    </div>
                </div>
            </div>
...
const onSignUpSubmit = async () => {
    ...
    try {
        ...
        if(formObject.password && formObject.confirmPassword && formObject.password !== formObject.confirmPassword) {
