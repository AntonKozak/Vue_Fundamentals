    ...
    <div class="mx-auto">
      <div class="mb-4 border-bottom d-flex justify-content-between align-items-center py-3">
        <h3 class="fw-semibold text-success">
          {{ menuItemIdForUpdate ? 'Edit Menu' : 'Add Menu' }}
        </h3>
        <div class="d-flex gap-3">
          ...
          <button
            @click="router.push({ name: APP_ROUTES_NAMES.MENU_ITEM_LIST })"
            type="button"
      ...
      >
        <div class="row g-4">
          ...
          <div class="col-lg-5">
            <div>
              <img
                v-if="newUploadImage_base64 || menuItemObj.image"
                :src="
                  newUploadImage_base64 ||
                  (menuItemObj.image ? CONFIG_IMAGE_URL + menuItemObj.image : '')
                "
