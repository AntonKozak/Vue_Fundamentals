    ...
    <div class="card-header border-bottom-0 pt-4">
      <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
          <i
            class="bi bi-receipt-cutoff text-success pe-2"
    ...
    <div class="card-body">
      <div class="mb-4">
        <div class="d-flex align-items-center mb-3">
          <i
            class="bi bi-person-square text-success pe-2"
      ...
      <div class="bg-body-tertiary rounded-3 p-3">
        ...
        <div class="mb-3 pb-3 border-bottom" v-for="item in order.orderDetails" :key="item.menuItemId">
          <div class="d-flex justify-content-between align-items-center mb-2">
            <div class="d-flex align-items-center">
              <span class="text-truncate me-3">{{ item.itemName }}</span>
            </div>
            <div class="d-flex align-items-center">
