<template>
    <div v-if="show" class="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center bg-black bg-opacity-50"
        style="z-index: 1050">
        <div class="modal-dialog modal-dialog-centered m-0 modal-size d-flex flex-column rounded-4"
            ...
            <div class="modal-content rounded-4 border-0 rounded-0 rounded-md-4 bg-body h-100 d-flex flex-column">
                ...
                <div
                    ...
                    <button @click="closeModal" type="button" class="btn-close" aria-label="Close menu details"></button>
                </div>
                    ...
                    <div class="row g-3 g-sm-4">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="position-relative">
                                <img :src="CONFIG_IMAGE_URL + menuItem.image" class="rounded-4 w-100 object-fit-cover"
                ...
                <div class="modal-footer border-0 px-3 px-sm-4 pb-3 pb-sm-4 sticky-bottom bg-body">
                    <button @click="closeModal" type="button" class="btn btn-outline-secondary rounded-pill px-3 px-sm-4 w-100">
                        Close
                    </button>
                </div>
            </div>
